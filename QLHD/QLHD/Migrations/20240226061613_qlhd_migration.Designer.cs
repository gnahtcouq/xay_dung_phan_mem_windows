...
namespace QLHD.Migrations
{
    ...
    [Migration("20240226061613_qlhd_migration")]
    partial class qlhd_migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLHD.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("QLHD.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("QLHD.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("QLHD.Models.Chitiethoadon", b =>
                {
                    b.HasOne("QLHD.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("QLHD.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
